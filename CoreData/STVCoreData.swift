...
class STVCoreData: NSObject {
    
    static let sharedInstance = STVCoreData()
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("STVCoreData", withExtension: "momd")!
...
//    }
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationCachesDirectory.URLByAppendingPathComponent("STVCoreData.sqlite")
    ...
    class func ctx() -> NSManagedObjectContext{
        return self.sharedInstance.managedObjectContext
    }
    
    class func saveContext () {
        if self.sharedInstance.managedObjectContext.hasChanges {
            do {
                try self.sharedInstance.managedObjectContext.save()
            } catch {
